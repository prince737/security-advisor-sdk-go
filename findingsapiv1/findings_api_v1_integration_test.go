...
func TestGetOccurrence(t *testing.T) {
	...
	if result != nil {
		...
		assert.Equal(t, *(res.ProviderID), *(createOccurrenceOptions.ProviderID))
...
func TestCreateOccurrence(t *testing.T) {
	...
	assert.Equal(t, *(result.ProviderID), *(createOccurrenceOptions.ProviderID))
	...
	assert.Equal(t, *(result.ProviderID), *(createOptions.ProviderID))
...
func TestPostCardUsingSetters(t *testing.T) {
	...
	cardValueKind := findingsapiv1.FindingCountValueType_Kind_FindingCount
